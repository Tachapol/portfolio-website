...
const groups = [
  {
    category: "Languages",
    items: ["Python", "SQL", "Scala", "TypeScript", "Bash"],
  },
  {
    category: "Data & Processing",
    items: ["Apache Spark", "dbt", "Airflow", "Kafka", "Flink", "Iceberg"],
  },
  {
    category: "Warehouses & Storage",
    items: ["Snowflake", "BigQuery", "Redshift", "Postgres", "DuckDB"],
  },
  {
    category: "Cloud & Infra",
    items: ["AWS", "GCP", "Terraform", "Docker", "Kubernetes"],
  },
  {
